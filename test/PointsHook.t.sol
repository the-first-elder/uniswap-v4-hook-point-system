...
contract TestPointsHook is Test, Deployers {
    ...
    function setUp() public {
        ...
        // using an instance of my contract...
        ...
        (key,) = initPool(
            ...
            hook, // Hook Contract
            3000, // Swap Fees
            SQRT_PRICE_1_1, // Initial Sqrt(P) value = 1 // trying to get the price if its a decimal...
    ...
    function test_addLiquidityAndSwap() public {
        ...
        // amount  delta is the amount of token A needed to be added to the pool
        // amount 1 delta is the amount of token B needed to be added to the pool
