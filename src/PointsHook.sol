...
contract PointsHook is BaseHook, ERC20 {
    ...
    function afterSwap(
        ...
        // currency 0 is the first pair of the token would be eth most of the time ...

        if (!swapParams.zeroForOne) return (this.afterSwap.selector, 0);
        //  ensure only eth is used to purchase the token , but i think any tokne here can buy with this line buth the line above  ensure only eth gets to this point
